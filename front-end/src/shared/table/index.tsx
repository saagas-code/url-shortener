  ...
  if (links.length) {
    return (
      <>
        <div className="table-container">
          ...
          <div className="table-body">
            {links.map((item, index) => {
              const date = getDateLink(item.createdAt);
                  ...
                  <div style={{ position: "relative" }} className="">
                    <div key={index} className="table-row ">
                      <div className="short-link">
                        ...
                        <img
                          onClick={() =>
                            copyText(`${config.frontEndUrl}/${item.shortener}`)
                          }
                          className="copy"
                          src="/assets/copy.svg"
                          alt=""
                      ...
                      <div className="head-cell clicks">{item.clicks}</div>
                      <div onClick={() => handleQrCode(item.shortener)} className="qr-code">
        ...
        <Modal isOpen={isQrOpen} onModalClose={closeModal}>
            <QrCode link={QrResult} />
        </Modal>
      </>
    );
  }
